...
superWomen = new SuperWomen (400,30,100,100);
...
box7 = new Box(800,100,70,70);
 ...
 superwomen =new SuperWomen(200,200,250,200);
...
function draw(){
    ...
    fill("purple")
    textSize(30)
    text("Drag The Mouse To Move Superwomen  And Kill The Bad Monster!!",10,30)
...
function mouseDragged(){
    Matter.Body.setPosition(superWomen.body,{x:mouseX,y:mouseY})
}
